...
<head>
  ...
  <title>Update Bid | Luxe Auctions</title>
...
<main class="container mx-auto px-6 py-8 max-w-4xl">
  <div class="bg-secondary rounded-xl shadow-lg p-8">
    ...
    <!-- Bid Form -->
    <form id="bidForm" action="${pageContext.request.contextPath}/updateBidServlet" method="post">
      <input type="hidden" name="bidId" value="${auction.getId()}">
